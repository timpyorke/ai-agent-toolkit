...
```dart
// lib/features/number_trivia/data/repositories/number_trivia_repository_impl.dart
...
### Bloc
```dart
// lib/features/number_trivia/presentation/bloc/number_trivia_bloc.dart
  ...
  void _onGetTriviaForConcreteNumber(
    ...
    await inputEither.fold(
      ...
      (integer) async {
        ...
        _emitEither(emit, failureOrTrivia);
      },
    );
  }
