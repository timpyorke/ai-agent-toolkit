...
> **Category**: Data & ML  
> **Audience**: Data engineers, ML engineers, backend engineers  
> **Prerequisites**: Understanding of databases, data modeling, SQL  
> **Complexity**: Advanced

## Overview

Data pipelines move and transform data from sources to destinations reliably, efficiently, and at scale. This skill covers ETL vs ELT patterns, orchestration with Airflow/Prefect/Dagster, data quality checks, data lineage, incremental processing, idempotency, and schema evolution—enabling robust data infrastructure for analytics and ML.

## Why Data Pipelines?

**Without pipelines**: Manual data copying, inconsistent transformations, data quality issues, hard-to-debug failures.

**With pipelines**: Automated, reproducible data flows with clear lineage, quality guarantees, and failure recovery.

**Real-world scenario**:

```
E-commerce company needs:
  - Daily sales aggregations for dashboards
  - User behavior data for ML models
  - Real-time inventory updates

Solution: Data pipeline that:
  - Extracts from Postgres, Kafka, S3
  - Transforms with dbt, Spark
  - Loads to data warehouse (Snowflake, BigQuery)
